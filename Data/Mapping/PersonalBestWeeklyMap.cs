...
public partial class PersonalBestWeeklyMap
    : IEntityTypeConfiguration<Zeepkist.GTR.Database.Data.Entities.PersonalBestWeekly>
{
    public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Zeepkist.GTR.Database.Data.Entities.PersonalBestWeekly> builder)
    {
        ...
        builder.HasOne(t => t.LevelLevelMetadata)
            .WithMany(t => t.LevelPersonalBestWeeklies)
            .HasForeignKey(d => d.Level)
            .HasConstraintName("personal_bests_weekly_level_fkey");
